...
4. Apply an allow rule for each (step 5 of the workflow), scoped as tightly as is reasonable, in the right file under `~/.claude/permissions.d/` (see its [README](~/.claude/permissions.d/README.md) for the existing file layout).
