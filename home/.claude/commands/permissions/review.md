...
4. Apply each choice (step 5 of the workflow) by editing the right file under `~/claude-config/home/.claude/permissions.d/` (see its [README](~/claude-config/home/.claude/permissions.d/README.md) for the existing file layout).
